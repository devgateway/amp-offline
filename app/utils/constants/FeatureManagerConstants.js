...
export const ACTIVITY_ORGANIZATIONS_DONOR_ORGANIZATION_ADD_FUNDING_AUTO = `${ACTIVITY_ORGANIZATIONS}/Donor Organization/${ADD_FUNDING_AUTO}`;
...
export const ACTIVITY_ORGANIZATIONS_FUNDING_ORGANIZATION_ADD_FUNDING_AUTO = `${ACTIVITY_ORGANIZATIONS}/Funding Organization/${ADD_FUNDING_AUTO}`;
