...
export const ACTIVITY_ORGANIZATIONS_FUNDING_ORGANIZATION = `${ACTIVITY_ORGANIZATIONS}/Funding Organization`;
...
export const ACTIVITY_ORGANIZATIONS_BENEFICIARY_AGENCY_ADD_FUNDING_AUTO = `${ACTIVITY_ORGANIZATIONS}/Beneficiary Agency/${ADD_FUNDING_AUTO}`;
export const ACTIVITY_ORGANIZATIONS_CONTRACTING_AGENCY_ADD_FUNDING_AUTO = `${ACTIVITY_ORGANIZATIONS}/Contracting Agency/${ADD_FUNDING_AUTO}`;
export const ACTIVITY_ORGANIZATIONS_DONOR_ORGANIZATION_ADD_FUNDING_AUTO = `${ACTIVITY_ORGANIZATIONS}/Funding Organization/${ADD_FUNDING_AUTO}`;
export const ACTIVITY_ORGANIZATIONS_EXECUTING_AGENCY_ADD_FUNDING_AUTO = `${ACTIVITY_ORGANIZATIONS}/Executing Agency/${ADD_FUNDING_AUTO}`;
export const ACTIVITY_ORGANIZATIONS_IMPLEMENTING_AGENCY_ADD_FUNDING_AUTO = `${ACTIVITY_ORGANIZATIONS}/Implementing Agency/${ADD_FUNDING_AUTO}`;
...
export const ACTIVITY_ORGANIZATIONS_RESPONSIBLE_ORGANIZATION_ADD_FUNDING_AUTO = `${ACTIVITY_ORGANIZATIONS}/Related Government Organization/${ADD_FUNDING_AUTO}`;
