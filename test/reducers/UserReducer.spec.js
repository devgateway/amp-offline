...
describe('@@ UserReducer @@', () => {
  ...
  it('func userReducer - Test type: STATE_LOGIN_OK should return the user data without teamMember', () => {
    ...
    })).to.deep.equal({userData: {id: "123", name: "test123"}, teamMember:undefined, plainPassword:"abc", token: "a123456789b"});
  });
  ...
  it('func userReducer - Test type: STATE_SELECT_WORKSPACE should return user data and teamMember', () => {
    ...
    })).to.deep.equal({userData: {id: "123", name: "test123"}, plainPassword:"abc", token: "a123456789b", teamMember: teamMember});
  });
